...
import sys
sys.path.append("..")
from Deep_Q_Learning.MLP_Brain import MLP_Brain as Brain
...
class MLP_Brain(Brain):
    def __init__(
        ...
        super(MLP_Brain, self).__init__(n_actions, n_features, neurons_per_layer,  activation_function, Optimizer,

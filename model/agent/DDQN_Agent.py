...
class DDQN_Agent(agent):
    def __init__(
        ...
        super(DDQN_Agent, self).__init__(brain, observation_space_shape, n_actions,  reward_decay, MAX_EPSILON,
    ...
    def learn(self, costFlag=False):
        ...
        if self.learn_step_counter % self.replace_target_iter == 0:
            ...
            print('\nDDQN_Agent learn_step_counter=', self.learn_step_counter, ' target_params_replaced')

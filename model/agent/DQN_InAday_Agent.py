...
class DQN_InAday_Agent(agent):
    def __init__(
        ...
        super(DQN_InAday_Agent, self).__init__(brain, observation_space_shape, n_actions,  reward_decay, MAX_EPSILON,
    ...
    def learn(self):
        ...
        # 训练 eval 神经网络
        self.brain.train(states, q_target, one_hot_action, q_lower_max, q_upper_min, self.learn_step_counter)
        # ----------------------------------------------------------------------

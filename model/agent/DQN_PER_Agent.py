...
class DQN_PER_Agent(agent):
    def __init__(
        ...
        super(DQN_PER_Agent, self).__init__(brain, observation_space_shape, n_actions,  reward_decay, MAX_EPSILON,

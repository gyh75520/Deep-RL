...
import numpy as np
from .DQN_PER_Ipm_Agent import DQN_PER_Ipm_Agent as agent


class DDQN_PER_Ipm_Agent(agent):
    def __init__(
        self,
        brain,  # 使用的神经网络
        ...
        super(DDQN_PER_Ipm_Agent, self).__init__(brain, observation_space_shape, n_actions,  reward_decay, MAX_EPSILON,
    ...
    def learn(self, costFlag=False):
        ...
        if self.learn_step_counter % self.replace_target_iter == 0:
            ...
            print('\DDQN_PER_Ipm_Agent learn_step_counter=', self.learn_step_counter, ' target_params_replaced')
